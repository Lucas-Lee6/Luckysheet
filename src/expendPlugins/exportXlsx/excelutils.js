...
export function exportSheetExcel(luckySheet,luckyJson,name='新建工作表') { // 参数为luckysheet.getluckysheetfile()获取的对象
    // 1.创建工作簿，可以为工作簿添加属性
    ...
    var tableArr
    if(luckyJson.exportXlsx.order == 'all'){
        tableArr = luckyJson.data;
    }else{
